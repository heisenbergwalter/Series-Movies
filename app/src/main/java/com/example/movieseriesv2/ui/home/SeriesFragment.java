...
public class SeriesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(com.example.cinemaseries.R.layout.serie_fragement, container, false); // your layout
        ...
        serieViewModel.getSerieList().observe(getViewLifecycleOwner(), series -> {
            serieAdapter.updateSeries(series); // Make sure this replaces/appends correctly
        });
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                if (layoutManager != null && layoutManager.findLastVisibleItemPosition() >= serieAdapter.getItemCount() - 5) {
                    serieViewModel.loadMoreSeries();  // You must define this method in the ViewModel
                }
            }
        });
